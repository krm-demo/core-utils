...
public class JacocoHelper {
    ...
    private final BadgeVersionProvider bp = new BadgeVersionProvider.FuncRec(
        this::badgeImageUrl,
        this::badgeTargetUrl,
        (String versionStr) -> "JaCoCo report" + (StringUtils.isBlank(versionStr) ? "" : " for " + versionStr),
        (String _versionStr) -> getBadgeTooltip()   // <-- TODO: make it te depend on versionStr !!!
    );
    ...
    /**
     * @param _versionStr unused here
     * @return a target URL to the test-coverage report that was generated by {@code JaCoCo}-library
     */
    public String badgeTargetUrl(String _versionStr) {
        // TODO: think about using "MavenHelper.getProjectCatalogName()"
        return String.format("https://krm-demo.github.io/core-utils/%s-%s/jacoco-reports",
    ...
    public String getBadgeValue() {
        // TODO: make it te depend on version !!!
