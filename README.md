...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.22.001-SNAPSHOT).
...
This particular version of the project `21.22.001-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.22.001-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.22.001-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.22.001-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.22.001-SNAPSHOT
...
> during GitHub Workflow [`release-public`](https://github.com/krm-demo/core-utils/actions/runs/18892895320).
...
```json
{
  "calculatedProjectVersion": "21.22.001-SNAPSHOT",
  "currentProjectVersion": "21.22.001-SNAPSHOT",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.22.002-SNAPSHOT",
  "internalReleaseVersion": "21.22.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "22",
  "minorVersionAsInt": "22",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.22.001-SNAPSHOT",
  "projectName": "core-utils:21.22.001-SNAPSHOT",
...
```json
{
  ...
  "badgeSnapshotGitHubMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.22.001--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils)",
  "badgeSnapshotJavaDocMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.22.001--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.22.001-SNAPSHOT)",
  ...
  "badgeUrlSnapshotGitHub": "https://img.shields.io/badge/core--utils-21.22.001--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlSnapshotJavaDoc": "https://img.shields.io/badge/core--utils-21.22.001--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "mavenInternal": "true",
  "mavenSnapshot": "true",
  "snapshotVersion": "21.22.001-SNAPSHOT"
}
```
</details>
