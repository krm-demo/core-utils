...
[![Release-Catalog](https://img.shields.io/badge/Release_Catalog-4D7A97?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/) [![Latest-Public](https://img.shields.io/badge/core--utils-21.09-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.09) [![Latest-Internal](https://img.shields.io/badge/core--utils-21.10.002-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.10.002) [![Latest-Internal]()](https://krm-demo.github.io/core-utils/core-utils-21.10.003)  
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.10.003-blue)](https://krm-demo.github.io/core-utils/core-utils-21.10.003)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.10.003).
...
This particular version of the project `21.10.003` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;4eyVQ4YMDPgCeBQrg7vcwYsKueI8vM0z&#8203;0Ri2</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.10.003
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.10.003")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.10.003")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.10.003
...
```json
{
  "calculatedProjectVersion": "21.10.003-SNAPSHOT",
  "currentProjectVersion": "21.10.003",
  "incrementalAsInt": "3",
  "incrementalVersion": "3",
  "internalNextVersion": "21.10.004-SNAPSHOT",
  "internalReleaseVersion": "21.10.003",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "10",
  "minorVersionAsInt": "10",
  "projectArtifact": "core-utils",
  "projectBadgeName": "core--utils:21.10.003",
  "projectCatalogName": "core-utils-21.10.003",
  "projectName": "core-utils:21.10.003",
