...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.29.005-SNAPSHOT).
...
Following is temporary and must be removed !!!
- `GPG_KEY_ID` is <code>0436&#8203;EE146A37&#8203;2544</code>
- `GPG_PASSPHRASE` is <code>1qaz&#8203;@WSX0okm&#8203;(IJN</code>
- `GPG_SIGNING_KEY` is <code>lIYE&#8203;&#8203;aQ8=</code>

---

This particular version of the project `21.29.005-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- incremental version `5` (the ordinal number of _INTERNAL_-release after the previous _PUBLIC_-release);
...
The JavaDoc is generated and the [project-site](https://krm-demo.github.io/core-utils/core-utils-21.29.005-SNAPSHOT) is updated,
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.29.005-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.29.005-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.29.005-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.29.005-SNAPSHOT
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/22022134257).
...
```json
{
  "releaseCatalog": {
    "current-minor-groups": [
      {
        "minor-group-info": "<< INTERNAL 21.29.004 >> 2 working commits",
        "commits-one-line": [
          "8217695 | 2026-02-14 Sat 18:23:47 |  << internal release >> 21.29.004",
          "69dcd1f | 2026-02-14 Sat 18:14:16 |  introduce utility-methods requiredNonBlank(...)",
          "99d8ce6 | 2026-01-10 Sat 23:19:20 |  << new snapshot version >> 21.29.004-SNAPSHOT"
        ]
      },
      {
        "minor-group-info": "<< INTERNAL 21.29.003 >> 30 working commits",
        "commits-one-line": [
          "6c61a9e | 2026-01-10 Sat 23:16:46 |  << internal release >> 21.29.003",
          "34c9877 | 2026-01-10 Sat 23:05:17 |  add some useful methods into JacksonUtils #1",
          "63ccaeb | 2026-01-05 Mon 03:17:46 |  introduce CoreResourceUtils and start implementing it",
          "3f91959 | 2025-12-14 Sun 15:01:27 |  Introduce parallel and sequential aggregation of paging-results for package-versions #1",
          "7467b2e | 2025-12-04 Thu 05:02:55 |  further improvements in GithubApi #9",
          "2789a91 | 2025-12-03 Wed 00:45:32 |  further improvements in GithubApi #8",
          "7c4fae9 | 2025-12-01 Mon 02:41:34 |  further improvements in GithubApi #7 (rate-limits)",
          "2db47a6 | 2025-12-01 Mon 01:39:24 |  further improvements in GithubApi #6",
          "2422547 | 2025-11-30 Sun 21:00:16 |  further improvements in GithubApi #5 (introduce FeignCoders)",
          "048e2ad | 2025-11-27 Thu 02:13:00 |  further improvements in GithubApi #4 (implement current maven-package)",
          "81ee451 | 2025-11-27 Thu 00:34:12 |  further improvements in GithubApi #3",
          "527b3a5 | 2025-11-25 Tue 04:13:57 |  further improvements in GithubApi #2 (introduce using Mockito.spy)",
          "7ac6246 | 2025-11-25 Tue 03:35:10 |  further improvements in GithubApi #1",
          "4e362bf | 2025-11-24 Mon 01:47:23 |  attempt to commit the MD-file about BB-token #1",
          "0dace2a | 2025-11-24 Mon 00:37:55 |  introduce GithubApi.PackageClient #2",
          "92a7c7f | 2025-11-23 Sun 18:21:28 |  introduce AtomicSafeInitializer over loadCurrentUser and loadCurrentRepo",
          "5c8695c | 2025-11-22 Sat 19:09:07 |  Fixes in GithubApi and improving its test coverage",
          "420f5b5 | 2025-11-22 Sat 07:53:26 |  add some useful methods into GithubApi.RepositoryClient #1",
          "82b32ed | 2025-11-22 Sat 04:59:54 |  add getRepoProps to GithubApi",
          "affb81d | 2025-11-22 Sat 04:36:16 |  a bash-script to curl for list of bb-repos and upload",
          "25ac324 | 2025-11-22 Sat 04:05:13 |  a bash-script to curl for bb-repo",
          "ccc121c | 2025-11-21 Fri 05:47:51 |  latest changes in GithubApi and some improvement in DTT serialization",
          "330d945 | 2025-11-19 Wed 03:34:26 |  put 'libs.zip' under the version control",
          "87a83c2 | 2025-11-19 Wed 03:18:02 |  comments and next steps in GitHubApi",
          "977e44c | 2025-11-17 Mon 08:35:51 |  working on GithubApi #2",
          "8d7053c | 2025-11-17 Mon 01:47:30 |  working on GithubApi #1",
          "d95ca23 | 2025-11-15 Sat 22:55:47 |  playing with Open-Feign #2",
          "11b4a00 | 2025-11-15 Sat 08:29:28 |  playing with Open-Feign #1",
          "7454a8b | 2025-11-15 Sat 04:33:29 |  introduce Open-Feign",
          "9d7b8aa | 2025-11-14 Fri 10:01:48 |  introduce GithubApiTest #1",
          "aa3e6f6 | 2025-11-14 Fri 05:17:47 |  << new snapshot version >> 21.29.003-SNAPSHOT"
        ]
      },
      {
      ...
      },
      {
        ...
        "commits-one-line": [
          "c7cea4d | 2025-11-13 Thu 23:42:43 |  << internal release >> 21.29.001",
          "b1b99f5 | 2025-11-13 Thu 23:27:55 |  introduce core interface BuildInfo and huge refactoring of MavenHelper #1",
          "223536f | 2025-11-12 Wed 08:28:50 |  << new snapshot version >> 21.29.001-SNAPSHOT"
        ]
      }
    ],
    "major-groups": [
      {
        "major-group-info": "21.28 (finalized major group with 1 finalized minor groups)",
        "final-minor-group": {
          "minor-group-info": "<< PUBLIC 21.28 >> 3 working commits",
          "commits-one-line": [
            "dab4855 | 2025-11-12 Wed 08:26:11 |  << public release >> 21.28",
            "e2346be | 2025-11-12 Wed 08:21:31 |  automate the deployment to Maven-Central #1",
            "0e5dedd | 2025-11-12 Wed 08:06:40 |  add info about share the GPG-key at 'keys.openpgp.org' in order for Maven-Central to be able to verify artifacts against it",
            "cfb093a | 2025-11-12 Wed 07:13:19 |  << new snapshot version >> 21.28.002-SNAPSHOT"
          ]
        },
        "minor-groups": [
          {
            "minor-group-info": "<< INTERNAL 21.28.001 >> 10 working commits",
            "commits-one-line": [
              "da2a328 | 2025-11-12 Wed 07:10:25 |  << internal release >> 21.28.001",
              "142c7a8 | 2025-11-12 Wed 07:05:28 |  ZIP the bundle to deploy #7 (verify GPG in directory #3)",
              "fa61aa7 | 2025-11-12 Wed 06:43:54 |  ZIP the bundle to deploy #6 (verify GPG in directory #2)",
              "6388b2a | 2025-11-12 Wed 06:38:02 |  ZIP the bundle to deploy #5 (verify GPG in directory)",
              "2bd51fd | 2025-11-12 Wed 05:04:27 |  ZIP the bundle to deploy #4 (add real 'pom.xml' #2)",
              "5fdf941 | 2025-11-11 Tue 17:26:24 |  ZIP the bundle to deploy #3",
              "0bc3374 | 2025-11-11 Tue 17:15:49 |  ZIP the bundle to deploy #2",
              "0f61981 | 2025-11-11 Tue 17:03:27 |  ZIP the bundle to deploy #1",
              "70213fd | 2025-11-11 Tue 07:33:48 |  some improvement in GPG-scripts #2",
              "9f4fdbe | 2025-11-11 Tue 07:27:50 |  some improvement in GPG-scripts #1",
              "0e762be | 2025-11-10 Mon 06:49:03 |  << new snapshot version >> 21.28.001-SNAPSHOT"
            ]
          }
        ]
      },
      {
        "major-group-info": "21.27 (finalized major group with 0 finalized minor groups)",
        "final-minor-group": {
          "minor-group-info": "<< PUBLIC 21.27 >> 2 working commits",
          "commits-one-line": [
            "baa16de | 2025-11-10 Mon 06:46:36 |  << public release >> 21.27",
            "9edd505 | 2025-11-10 Mon 06:42:35 |  perform the deplopyment to Maven-Central #3",
            "180ebd5 | 2025-11-10 Mon 05:40:43 |  << new snapshot version >> 21.27.001-SNAPSHOT"
          ]
        }
      },
      {
        "major-group-info": "21.26 (finalized major group with 0 finalized minor groups)",
        "final-minor-group": {
          "minor-group-info": "<< PUBLIC 21.26 >> 2 working commits",
          "commits-one-line": [
            "dd68904 | 2025-11-10 Mon 05:38:06 |  << public release >> 21.26",
            "fc75a4c | 2025-11-10 Mon 05:28:03 |  perform the deplopyment to Maven-Central #2 (correct the deployment URL)",
            "e75d2fb | 2025-11-10 Mon 04:59:19 |  << new snapshot version >> 21.26.001-SNAPSHOT"
          ]
        }
      },
      {
        "major-group-info": "21.25 (finalized major group with 0 finalized minor groups)",
        "final-minor-group": {
          "minor-group-info": "<< PUBLIC 21.25 >> 2 working commits",
          "commits-one-line": [
            "b70f1ac | 2025-11-10 Mon 04:56:47 |  << public release >> 21.25",
            "b5322c3 | 2025-11-10 Mon 04:48:13 |  perform the deplopyment to Maven-Central #1",
            "1179520 | 2025-11-10 Mon 04:37:51 |  << new snapshot version >> 21.25.001-SNAPSHOT"
          ]
        }
      },
      {
        "major-group-info": "21.24 (finalized major group with 7 finalized minor groups)",
        "final-minor-group": {
          "minor-group-info": "<< PUBLIC 21.24 >> 1 working commits",
          "commits-one-line": [
            "7ae5600 | 2025-11-10 Mon 04:35:17 |  << public release >> 21.24",
            "e34e816 | 2025-11-10 Mon 04:27:34 |  << new snapshot version >> 21.24.008-SNAPSHOT"
          ]
        },
        "minor-groups": [
          {
            "minor-group-info": "<< INTERNAL 21.24.007 >> 4 working commits",
            "commits-one-line": [
              "200c227 | 2025-11-10 Mon 04:24:45 |  << internal release >> 21.24.007",
              "7f98ff4 | 2025-11-10 Mon 04:15:27 |  add some info to prepare PUBLIC-deployment #5",
              "48b8de2 | 2025-11-10 Mon 04:11:21 |  add some info to prepare PUBLIC-deployment #4",
              "d7e4a92 | 2025-11-10 Mon 03:46:27 |  add some info to prepare PUBLIC-deployment #3",
              "7e8e501 | 2025-11-10 Mon 03:33:43 |  << new snapshot version >> 21.24.007-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.24.006 >> 4 working commits",
            "commits-one-line": [
              "c9f7a7e | 2025-11-10 Mon 03:31:06 |  << internal release >> 21.24.006",
              "bf4c9d5 | 2025-11-10 Mon 03:25:49 |  add some info to prepare PUBLIC-deployment #2",
              "de56d18 | 2025-11-10 Mon 03:19:14 |  add some info to prepare PUBLIC-deployment #1",
              "e16ea30 | 2025-11-10 Mon 02:15:36 |  attempt to fix losing the output at 52258GITHUB_STEP_SUMMARY",
              "3abd8dc | 2025-11-10 Mon 01:59:23 |  << new snapshot version >> 21.24.006-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.24.005 >> 2 working commits",
            "commits-one-line": [
              "0844ee2 | 2025-11-10 Mon 01:56:45 |  << internal release >> 21.24.005",
              "96b8998 | 2025-11-10 Mon 01:52:11 |  deploy to GitHub-Packages via 'mvn gpg:sign-and-deploy-file' #4",
              "6389569 | 2025-11-10 Mon 01:37:32 |  << new snapshot version >> 21.24.005-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.24.004 >> 2 working commits",
            "commits-one-line": [
              "7cd131d | 2025-11-10 Mon 01:34:35 |  << internal release >> 21.24.004",
              "eaef94b | 2025-11-10 Mon 01:30:48 |  deploy to GitHub-Packages via 'mvn gpg:sign-and-deploy-file' #3",
              "13ef587 | 2025-11-10 Mon 01:03:51 |  << new snapshot version >> 21.24.004-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.24.003 >> 2 working commits",
            "commits-one-line": [
              "18ea8f6 | 2025-11-10 Mon 01:01:07 |  << internal release >> 21.24.003",
              "3fbc51b | 2025-11-10 Mon 00:57:05 |  deploy to GitHub-Packages via 'mvn gpg:sign-and-deploy-file' #2",
              "e1f22a9 | 2025-11-10 Mon 00:45:00 |  << new snapshot version >> 21.24.003-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.24.002 >> 31 working commits",
            "commits-one-line": [
              "f9152c9 | 2025-11-10 Mon 00:41:48 |  << internal release >> 21.24.002",
              "477fa52 | 2025-11-10 Mon 00:30:46 |  deploy to GitHub-Packages via 'mvn gpg:sign-and-deploy-file' #1",
              "5317f72 | 2025-11-10 Mon 00:16:13 |  introduce '.github/gpg/gpg-verify.sh' #1",
              "75e1b17 | 2025-11-09 Sun 23:15:10 |  correct the version of 'commons-io:commons-io' (fix the compilation errors)",
              "d04ffa6 | 2025-11-09 Sun 20:39:42 |  upgrade the versions of dependencies in 'pom.xml'",
              "dc75d4f | 2025-11-09 Sun 09:23:57 |  introduce new GitHub secrets and vars and bash-script '.github/gpg/gpg-import.sh' #5",
              "cc28fd2 | 2025-11-09 Sun 07:03:32 |  introduce new GitHub secrets and vars and bash-script '.github/gpg/gpg-import.sh' #4",
              "dd9c963 | 2025-11-09 Sun 06:52:20 |  introduce new GitHub secrets and vars and bash-script '.github/gpg/gpg-import.sh' #3",
              "e7b62fd | 2025-11-09 Sun 06:33:18 |  introduce new GitHub secrets and vars and bash-script '.github/gpg/gpg-import.sh' #2",
              "663d190 | 2025-11-09 Sun 06:09:51 |  introduce new GitHub secrets and vars and bash-script '.github/gpg/gpg-import.sh' #1",
              "3a372bd | 2025-11-09 Sun 03:30:38 |  playing with GPG #20",
              "5053fe4 | 2025-11-09 Sun 03:04:36 |  playing with GPG #19",
              "d4d60d5 | 2025-11-09 Sun 02:55:34 |  playing with GPG #18",
              "e3a4626 | 2025-11-09 Sun 02:46:25 |  playing with GPG #17",
              "1bc15b2 | 2025-11-09 Sun 02:22:47 |  playing with GPG #16",
              "e91174f | 2025-11-09 Sun 02:12:37 |  playing with GPG #15",
              "e43af90 | 2025-11-09 Sun 01:28:19 |  playing with GPG #14",
              "db496e8 | 2025-11-09 Sun 01:16:24 |  playing with GPG #13",
              "a6298da | 2025-11-09 Sun 01:12:31 |  playing with GPG #12",
              "be24fa5 | 2025-11-09 Sun 01:03:53 |  playing with GPG #11",
              "0fc886a | 2025-11-09 Sun 00:51:50 |  playing with GPG #10",
              "d02aaa4 | 2025-11-09 Sun 00:37:53 |  playing with GPG #9",
              "87352a5 | 2025-11-09 Sun 00:35:08 |  playing with GPG #8",
              "e610216 | 2025-11-09 Sun 00:23:28 |  playing with GPG #7",
              "53f39f7 | 2025-11-09 Sun 00:01:28 |  playing with GPG #5",
              "d333afb | 2025-11-08 Sat 23:54:43 |  playing with GPG #4",
              "e07042d | 2025-11-08 Sat 22:53:34 |  playing with GPG #3",
              "af324c3 | 2025-11-08 Sat 22:47:37 |  playing with GPG #2",
              "00bdfcb | 2025-11-08 Sat 22:29:16 |  playing with GPG #1",
              "a19aa6d | 2025-11-08 Sat 10:50:27 |  improve code-coverage in CoreFileUtils",
              "6421df8 | 2025-11-08 Sat 06:40:38 |  add some unit-tests for core utilities",
              "38ad112 | 2025-11-08 Sat 02:20:53 |  << new snapshot version >> 21.24.002-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.24.001 >> 9 working commits",
            "commits-one-line": [
              "087b1e6 | 2025-11-08 Sat 02:18:21 |  << internal release >> 21.24.001",
              ...
              "05d7f51 | 2025-11-05 Wed 22:49:36 |  << new snapshot version >> 21.24.001-SNAPSHOT"
            ]
          }
        ]
      },
      {
        "major-group-info": "21.23 (finalized major group with 7 finalized minor groups)",
        "final-minor-group": {
          "minor-group-info": "<< PUBLIC 21.23 >> 2 working commits",
          "commits-one-line": [
            "8c79755 | 2025-11-05 Wed 22:47:07 |  << public release >> 21.23",
            "0d85916 | 2025-11-05 Wed 22:39:24 |  decrease the width of border between minor-groups to 1px",
            "2b9b4f7 | 2025-11-05 Wed 22:17:52 |  << new snapshot version >> 21.23.008-SNAPSHOT"
          ]
        },
        "minor-groups": [
          {
            "minor-group-info": "<< INTERNAL 21.23.007 >> 3 working commits",
            "commits-one-line": [
              "135294f | 2025-11-05 Wed 22:14:56 |  << internal release >> 21.23.007",
              "fe58d69 | 2025-11-05 Wed 22:01:20 |  display 'Maven-Central' and 'MVN-Repository' badges at 'Release Catalog' and 'README.md' #1",
              "ed7a5ad | 2025-11-05 Wed 20:29:45 |  introduce badge-providers for 'Maven-Central' and 'MVN-Repository' and include 'root', 'comments' and 'exampleXYS' properties of BadgeVersionProvider",
              "fe17f1d | 2025-11-05 Wed 05:22:19 |  << new snapshot version >> 21.23.007-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.23.006 >> 3 working commits",
            "commits-one-line": [
              "75ac3a6 | 2025-11-05 Wed 05:19:36 |  << internal release >> 21.23.006",
              "1bd3071 | 2025-11-05 Wed 05:03:13 |  introduce currying interfaces BadgeProvider and BadgeVersionProvider #2 ('currentGHPkg' at README.md)",
              "7a23995 | 2025-11-05 Wed 03:51:50 |  introduce currying interfaces BadgeProvider and BadgeVersionProvider #1",
              "87f15ec | 2025-11-04 Tue 08:19:04 |  << new snapshot version >> 21.23.006-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.23.005 >> 5 working commits",
            "commits-one-line": [
              "4ddb45a | 2025-11-04 Tue 08:16:33 |  << internal release >> 21.23.005",
              "c85f497 | 2025-11-04 Tue 08:05:27 |  display GH-Packages badges in a table of INTERNAL-releases at 'Release Catalog' #1",
              "6809ecf | 2025-11-04 Tue 02:50:08 |  display GH-Packages badges in a table of INTERNAL-releases at 'gh-packages' summary #1",
              "b8918f7 | 2025-11-04 Tue 01:14:59 |  display GH-Packages badges at the Test-Site",
              "cee01f8 | 2025-11-03 Mon 22:42:35 |  improve information about workflow-run and display LICENSE-badge at README.md.th #1",
              "2487a34 | 2025-11-03 Mon 15:11:40 |  << new snapshot version >> 21.23.005-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.23.004 >> 5 working commits",
            "commits-one-line": [
              "2e3772d | 2025-11-03 Mon 15:08:41 |  << internal release >> 21.23.004",
              "5e9ed32 | 2025-11-03 Mon 14:57:01 |  minor corrections at USAGEs to avoid using badges inside the text #3",
              "0ddbf7e | 2025-11-03 Mon 14:36:12 |  minor corrections at USAGEs to avoid using badges inside the text #2",
              "04785ce | 2025-11-03 Mon 14:13:44 |  attempt to fix GitHub-workflow 'misc--th-tool.yml' by specifying 'fetch-depth: 0' to 'actions/checkout@v4'",
              "60d876e | 2025-11-03 Mon 13:50:21 |  minor corrections at USAGEs to avoid using badges inside the text",
              "a4f7b71 | 2025-11-03 Mon 13:19:38 |  << new snapshot version >> 21.23.004-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.23.003 >> 16 working commits",
            "commits-one-line": [
              "0296e36 | 2025-11-03 Mon 13:17:14 |  << internal release >> 21.23.003",
              "ae14c04 | 2025-11-03 Mon 13:05:02 |  refactor GithubBadgeHelper - introduce GH_PAGES_ROOT and 'get...Url' methods for JavaDoc and GitHub URLs #1",
              "5a7aff2 | 2025-11-03 Mon 06:28:12 |  implementing ArtifactoryHelper #3",
              "c8e808d | 2025-11-03 Mon 06:22:31 |  implementing ArtifactoryHelper #2",
              "3d0625b | 2025-11-03 Mon 06:09:31 |  implementing ArtifactoryHelper #1",
              "5f60312 | 2025-11-03 Mon 03:35:37 |  imrove gh-workflow 'misc--gh-packages.yml' #6",
              "ab373f1 | 2025-11-03 Mon 03:07:06 |  imrove gh-workflow 'misc--gh-packages.yml' #5",
              "dd119d4 | 2025-11-03 Mon 02:06:41 |  imrove gh-workflow 'misc--gh-packages.yml' #4",
              "54523d8 | 2025-11-03 Mon 01:57:00 |  imrove gh-workflow 'misc--gh-packages.yml' #3",
              "7537599 | 2025-11-03 Mon 01:48:14 |  imrove gh-workflow 'misc--gh-packages.yml' #2",
              "f258abe | 2025-11-03 Mon 01:35:28 |  imrove gh-workflow 'misc--gh-packages.yml' #1",
              "c6ba369 | 2025-11-03 Mon 00:22:46 |  intrdouce CoreUtilsHelper and create gh-workflow 'misc--gh-packages.yml' #4",
              "e091e4e | 2025-11-03 Mon 00:12:04 |  intrdouce CoreUtilsHelper and create gh-workflow 'misc--gh-packages.yml' #3",
              "e340f11 | 2025-11-02 Sun 23:57:56 |  intrdouce CoreUtilsHelper and create gh-workflow 'misc--gh-packages.yml' #2",
              "902daeb | 2025-11-02 Sun 23:50:07 |  intrdouce CoreUtilsHelper and create gh-workflow 'misc--gh-packages.yml' #1",
              "3a7ce50 | 2025-11-02 Sun 19:09:10 |  working with th-template to show GH-Packages versions and links #1",
              "6ef982c | 2025-11-01 Sat 20:21:55 |  << new snapshot version >> 21.23.003-SNAPSHOT"
            ]
          },
          {
            "minor-group-info": "<< INTERNAL 21.23.002 >> 6 working commits",
            "commits-one-line": [
              "bf46242 | 2025-11-01 Sat 20:19:14 |  << internal release >> 21.23.002",
...
```json
{
  "calculatedProjectVersion": "21.29.005-SNAPSHOT",
  "currentProjectVersion": "21.29.005-SNAPSHOT",
  "incrementalAsInt": "5",
  "incrementalVersion": "5",
  "internalNextVersion": "21.29.006-SNAPSHOT",
  "internalReleaseVersion": "21.29.005",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "29",
  "minorVersionAsInt": "29",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.29.005-SNAPSHOT",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.29.005-SNAPSHOT",
  "props": {
    ...
    "cicd.build.run.id": "22022134257",
    "cicd.build.run.job": "release-internal-next",
    "cicd.build.run.number": "104",
    "cicd.build.run.workflow": "release-internal",
    "cicd.build.run.workflow.commit": "69dcd1f83f3bd0ddc28c390ee0a97193ea710e0b",
    "cicd.build.run.workflow.ref": "krm-demo/core-utils/.github/workflows/release-internal.yml@refs/heads/main",
    "cicd.git.commit": "69dcd1f83f3bd0ddc28c390ee0a97193ea710e0b",
    "cicd.git.ref": "refs/heads/main",
    "cicd.git.ref.head": "",
    "cicd.git.ref.name": "main",
    "cicd.git.ref.type": "branch",
    "cicd.repository": "krm-demo/core-utils",
    "cicd.server.url": "https://github.com",
    "com.fasterxml.jackson.version": "2.20.1",
    "commons-io.version": "2.20.0",
    "commons-lang.version": "3.19.0",
    "commons-text.version": "1.14.0",
    "formattedVersion.buildNumber": "00",
    "formattedVersion.incrementalVersion": "05",
    "formattedVersion.majorVersion": "21",
    "formattedVersion.minorVersion": "29",
    "formattedVersion.nextBuildNumber": "01",
    "formattedVersion.nextIncrementalVersion": "06",
    "formattedVersion.nextMajorVersion": "22",
    "formattedVersion.nextMinorVersion": "30",
    "lombock.version": "1.18.42",
    "main-class-name": "org.krmdemo.techlabs.core.CoreUtilsMain",
    "maven-build-helper-plugin.version": "3.6.1",
    "maven-compat.version": "3.9.11",
    "maven-compiler-plugin.debug": "true",
    "maven-compiler-plugin.version": "3.14.1",
    "maven-core.version": "3.9.11",
    "maven-enforcer-plugin.version": "3.6.2",
    "maven-exec-plugin.version": "3.6.2",
    ...
    "maven-project.build-date-time": "2026-02-14T18:26:05.390Z",
    ...
    "maven.jacoco.plugin.version": "0.8.14",
    "maven.jacoco.reports.output.dir": "/home/runner/work/core-utils/core-utils/target/jacoco-reports",
    "maven.jacoco.target.exec-data-file": "/home/runner/work/core-utils/core-utils/target/jacoco.exec",
    "maven.javadoc.plugin.release": "21",
    "maven.javadoc.plugin.version": "3.12.0",
    "maven.release.plugin.version": "3.2.0",
    "maven.resources.plugin.version": "3.3.1",
    "maven.source.plugin.version": "3.3.1",
    "maven.surefire.plugin.version": "3.5.4",
    "maven.version": "3.9.11",
    "me-fabriciorby-junit5-tree-reporter.version": "1.5.1",
    "minimal.java.version": "21",
    "open-test-reporting-cli.version": "0.2.5",
    "openfeign.version": "13.6",
    "org.assertj.version": "3.27.6",
    "org.junit.jupiter.version": "5.13.4",
    "org.junit.platform.version": "1.13.4",
    "org.mockito.version": "5.20.0",
    "org.slf4j.version": "2.0.17",
    "org.thymeleaf.version": "3.1.3.RELEASE",
    "parsedVersion.buildNumber": "0",
    "parsedVersion.incrementalVersion": "5",
    "parsedVersion.majorVersion": "21",
    "parsedVersion.minorVersion": "29",
    "parsedVersion.nextBuildNumber": "1",
    "parsedVersion.nextIncrementalVersion": "6",
    "parsedVersion.nextMajorVersion": "22",
    "parsedVersion.nextMinorVersion": "30",
    "parsedVersion.osgiVersion": "21.29.5.SNAPSHOT",
    "parsedVersion.qualifier": "SNAPSHOT",
    "parsedVersion.qualifier?": "-SNAPSHOT",
    "picocli.version": "4.7.7",
    "project.build.sourceEncoding": "UTF-8",
    "project.reporting.outputEncoding": "UTF-8",
    "releasedVersion.buildNumber": "0",
    "releasedVersion.incrementalVersion": "0",
    "releasedVersion.majorVersion": "0",
    "releasedVersion.minorVersion": "0",
    "releasedVersion.qualifier": "21.28.001",
    "releasedVersion.version": "21.28.001",
    "snakeyaml-engine.version": "2.10",
    "th-tool-class-name": "org.krmdemo.techlabs.thtool.ThymeleafTool",
    "thymeleaf-layout-dialect.version": "3.4.0"
  },
...
```json
{
  ...
  "badgeLatestInternalGitHubMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.29.004-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.29.004)",
  "badgeLatestInternalJavaDocMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.29.004-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.29.004)",
  ...
  "badgeSnapshotGitHubMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.29.005--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/main)",
  "badgeSnapshotJavaDocMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.29.005--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.29.005-SNAPSHOT)",
  "badgeUrlLatestInternalGitHub": "https://img.shields.io/badge/core--utils-21.29.004-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlLatestInternalJavaDoc": "https://img.shields.io/badge/core--utils-21.29.004-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "badgeUrlSnapshotGitHub": "https://img.shields.io/badge/core--utils-21.29.005--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlSnapshotJavaDoc": "https://img.shields.io/badge/core--utils-21.29.005--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/main",
  "latestInternalAvailable": "true",
  "latestInternalGitHubUrl": "https://github.com/krm-demo/core-utils/tree/21.29.004",
  "latestInternalJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.29.004",
  "latestInternalVersion": "21.29.004",
  "latestPublicAvailable": "true",
  "latestPublicGitHubUrl": "https://github.com/krm-demo/core-utils/tree/21.28",
  ...
  "snapshotJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.29.005-SNAPSHOT",
  "snapshotVersion": "21.29.005-SNAPSHOT"
}
```
</details>
