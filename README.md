...
[![Maven-Central site](https://img.shields.io/badge/maven--central-21.27-blue?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%%2BCiAgPGcgY2xhc3M9ImNscy0xIiA%%2BCjwvc3ZnPg%3D%3D&logoColor=415d7c&labelColor=415d7c)](https://central.sonatype.com/artifact/io.github.krm-demo/core-utils/21.27 "Maven-Central site for 'io.github.krm-demo:core-utils:21.27'")
[![MVN-Repository site](https://img.shields.io/badge/mvn--repo-21.27-blue?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB3aWR0aD0iMzVweCIgaGVpZ2h0PSIzNXB4IiB2aWV3Qm94PSIwIDUgMzAgMjUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI%2BCiAgPGcgc3R5bGU9ImRpc3BsYXk6aW5saW5lIj4KICAgIDxwYXRoIHN0eWxlPSJkaXNwbGF5OmlubGluZTtmaWxsOiMyNzZiYzA7ZmlsbC1vcGFjaXR5OjE7c3Ryb2tlLXdpZHRoOi4xOTM4MjQiIGQ9Ik0wIDBoNjN2MzVIMHoiIC8%%2BCiAgICA8L2c%2BCiAgPC9nPgo8L3N2Zz4%3D&logoColor=eee&labelColor=eee)](https://mvnrepository.com/artifact/io.github.krm-demo/core-utils/21.27 "MVN-Repository site for 'io.github.krm-demo:core-utils:21.27'")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.27).
...
This particular version of the project `21.27` is an _PUBLIC_-release version, which consists of
- major version `21` (that corresponds to minimal supported version of JDK);
- minor version `27` (the ordinal number of _PUBLIC_-release);
...
> with workflow-job [`release-public #28`](https://github.com/krm-demo/core-utils/actions/runs/19223133983)

This version is deployed into public [maven central repository](https://central.sonatype.com/) - so, it's available for usage
without additional downloading steps or local builds. As for Java-Doc it's either available at [![Latest-Public](https://img.shields.io/badge/core--utils-21.27-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.27)
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.27")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.27")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.27
...
> during GitHub Workflow [`release-public`](https://github.com/krm-demo/core-utils/actions/runs/19223133983).
...
```json
{
  "calculatedProjectVersion": "21.27.000-SNAPSHOT",
  "currentProjectVersion": "21.27",
  "incrementalAsInt": "0",
  "incrementalVersion": "0",
  "internalNextVersion": "21.27.001-SNAPSHOT",
  "internalReleaseVersion": "21.27.000",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "27",
  "minorVersionAsInt": "27",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.27",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.27",
  "publicNextVersion": "21.28.001-SNAPSHOT",
  "publicReleaseVersion": "21.27",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.27",
