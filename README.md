...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.21.002).
...
This particular version of the project `21.21.002` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;0BsLpXLMwj4MnUbPzvPl030dYpKk7Q1M&#8203;O85I</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.21.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.21.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.21.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.21.002
...
```json
{
  ...
  "currentProjectVersion": "21.21.002",
  "incrementalAsInt": "2",
  ...
  "projectCatalogName": "core-utils-21.21.002",
  "projectName": "core-utils:21.21.002",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.21.002",
