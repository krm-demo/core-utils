...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.10.003-SNAPSHOT).
...
This particular version of the project `21.10.003-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.10.003-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.10.003-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.10.003-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.10.003-SNAPSHOT
...
```json
{
  ...
  "currentProjectVersion": "21.10.003-SNAPSHOT",
  "incrementalAsInt": "3",
  ...
  "projectBadgeName": "core--utils:21.10.003--SNAPSHOT",
  "projectCatalogName": "core-utils-21.10.003-SNAPSHOT",
  "projectName": "core-utils:21.10.003-SNAPSHOT",
