...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.10.005).
...
This particular version of the project `21.10.005` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;LBDmJ8yNzjwsy7c8wlTVLOY6FY59EQ3I&#8203;OgxE</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.10.005
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.10.005")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.10.005")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.10.005
...
```json
{
  ...
  "currentProjectVersion": "21.10.005",
  "incrementalAsInt": "5",
  ...
  "projectBadgeName": "core--utils:21.10.005",
  "projectCatalogName": "core-utils-21.10.005",
  "projectName": "core-utils:21.10.005",
