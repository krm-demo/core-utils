...
[![Maven-Central site](https://img.shields.io/badge/maven--central-21.25-blue?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%%2BCiAgPGcgY2xhc3M9ImNscy0xIiA%%2BCjwvc3ZnPg%3D%3D&logoColor=415d7c&labelColor=415d7c)](https://central.sonatype.com/artifact/io.github.krm-demo/core-utils/21.25 "Maven-Central site for 'io.github.krm-demo:core-utils:21.25'")
[![MVN-Repository site](https://img.shields.io/badge/mvn--repo-21.25-blue?logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB3aWR0aD0iMzVweCIgaGVpZ2h0PSIzNXB4IiB2aWV3Qm94PSIwIDUgMzAgMjUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI%2BCiAgPGcgc3R5bGU9ImRpc3BsYXk6aW5saW5lIj4KICAgIDxwYXRoIHN0eWxlPSJkaXNwbGF5OmlubGluZTtmaWxsOiMyNzZiYzA7ZmlsbC1vcGFjaXR5OjE7c3Ryb2tlLXdpZHRoOi4xOTM4MjQiIGQ9Ik0wIDBoNjN2MzVIMHoiIC8%%2BCiAgICA8L2c%2BCiAgPC9nPgo8L3N2Zz4%3D&logoColor=eee&labelColor=eee)](https://mvnrepository.com/artifact/io.github.krm-demo/core-utils/21.25 "MVN-Repository site for 'io.github.krm-demo:core-utils:21.25'")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.25).
...
This particular version of the project `21.25` is an _PUBLIC_-release version, which consists of
- major version `21` (that corresponds to minimal supported version of JDK);
- minor version `25` (the ordinal number of _PUBLIC_-release);
...
> with workflow-job [`release-public #26`](https://github.com/krm-demo/core-utils/actions/runs/19221099634)

This version is deployed into public [maven central repository](https://central.sonatype.com/) - so, it's available for usage
without additional downloading steps or local builds. As for Java-Doc it's either available at [![Latest-Public](https://img.shields.io/badge/core--utils-21.25-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.25)
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.25")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.25")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.25
...
> during GitHub Workflow [`release-public`](https://github.com/krm-demo/core-utils/actions/runs/19221099634).
...
```json
{
  "calculatedProjectVersion": "21.25.000-SNAPSHOT",
  "currentProjectVersion": "21.25",
  "incrementalAsInt": "0",
  "incrementalVersion": "0",
  "internalNextVersion": "21.25.001-SNAPSHOT",
  "internalReleaseVersion": "21.25.000",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "25",
  "minorVersionAsInt": "25",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.25",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.25",
  "publicNextVersion": "21.26.001-SNAPSHOT",
  "publicReleaseVersion": "21.25",
...
```json
{
  ...
  "badgeLatestPublicGitHubMD": "[![Latest-Public](https://img.shields.io/badge/core--utils-21.25-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.25)",
  "badgeLatestPublicJavaDocMD": "[![Latest-Public](https://img.shields.io/badge/core--utils-21.25-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.25)",
  ...
  "badgeUrlLatestPublicGitHub": "https://img.shields.io/badge/core--utils-21.25-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlLatestPublicJavaDoc": "https://img.shields.io/badge/core--utils-21.25-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.25",
  ...
  "latestPublicGitHubUrl": "https://github.com/krm-demo/core-utils/tree/21.25",
  "latestPublicJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.25",
  "latestPublicVersion": "21.25",
  "mavenInternal": "false",
  "mavenSnapshot": "false",
  "snapshotGitHubUrl": "https://github.com/krm-demo/core-utils/tree/main",
  "snapshotJavaDocUrl": "",
  "snapshotVersion": "21.25"
}
```
</details>
