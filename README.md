...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.12.002).
...
This particular version of the project `21.12.002` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;1NifmotpGfFZJqLZ1k09UY76aGjeiv04&#8203;BoeO</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.12.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.12.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.12.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.12.002
...
```json
{
  ...
  "currentProjectVersion": "21.12.002",
  "incrementalAsInt": "2",
  ...
  "projectCatalogName": "core-utils-21.12.002",
  "projectName": "core-utils:21.12.002",
