[![on-main-push](https://github.com/krm-demo/core-utils/actions/workflows/on-main-push.yml/badge.svg?event=push)](https://github.com/krm-demo/core-utils/actions/workflows/on-main-push.yml)  [![Latest-Public](https://img.shields.io/badge/core--utils-21.18-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.18)  [![Snapshot-Version](https://img.shields.io/badge/core--utils-21.19.001--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils)

[![Release-Catalog](https://img.shields.io/badge/Release_Catalog-4D7A97?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/) [![Latest-Public](https://img.shields.io/badge/core--utils-21.18-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.18)  [![Snapshot-Version](https://img.shields.io/badge/core--utils-21.19.001--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.19.001-SNAPSHOT)  
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.19.001-SNAPSHOT).
...
This particular version of the project `21.19.001-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
- major version `21` (that corresponds to minimum available version of JDK);
- minor version `19` (the ordinal number of _PUBLIC_-release);
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.19.001-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.19.001-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.19.001-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.19.001-SNAPSHOT
...
> during GitHub Workflow [`release-public`](https://github.com/krm-demo/core-utils/actions/runs/18700266868).
...
```json
{
  "calculatedProjectVersion": "21.19.001-SNAPSHOT",
  "currentProjectVersion": "21.19.001-SNAPSHOT",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.19.002-SNAPSHOT",
  "internalReleaseVersion": "21.19.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "19",
  "minorVersionAsInt": "19",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.19.001-SNAPSHOT",
  "projectName": "core-utils:21.19.001-SNAPSHOT",
  "publicNextVersion": "21.20.001-SNAPSHOT",
  "publicReleaseVersion": "21.19",
