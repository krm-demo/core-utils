...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.23.002).
...
This particular version of the project `21.23.002` is an _INTERNAL_-release version, which consists of
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.23.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.23.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.23.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.23.002
...
```json
{
  ...
  "currentProjectVersion": "21.23.002",
  "incrementalAsInt": "2",
  ...
  "projectCatalogName": "core-utils-21.23.002",
  "projectName": "core-utils:21.23.002",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.23.002",
