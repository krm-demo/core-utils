...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.26.001-SNAPSHOT).
...
This particular version of the project `21.26.001-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
> [!IMPORTANT]
> It's highly recommended to use the latest _PUBLIC_-release [**`core-utils:21.25`**](https://github.com/krm-demo/core-utils/tree/21.25),
...
The JavaDoc is generated and the [project-site](https://krm-demo.github.io/core-utils/core-utils-21.26.001-SNAPSHOT) is updated,
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.26.001-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.26.001-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.26.001-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.26.001-SNAPSHOT
...
```json
{
  "calculatedProjectVersion": "21.26.001-SNAPSHOT",
  "currentProjectVersion": "21.26.001-SNAPSHOT",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.26.002-SNAPSHOT",
  "internalReleaseVersion": "21.26.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "26",
  "minorVersionAsInt": "26",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.26.001-SNAPSHOT",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.26.001-SNAPSHOT",
...
```json
{
  ...
  "badgeSnapshotGitHubMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.26.001--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/main)",
  "badgeSnapshotJavaDocMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.26.001--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.26.001-SNAPSHOT)",
  ...
  "badgeUrlSnapshotGitHub": "https://img.shields.io/badge/core--utils-21.26.001--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlSnapshotJavaDoc": "https://img.shields.io/badge/core--utils-21.26.001--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "snapshotJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.26.001-SNAPSHOT",
  "snapshotVersion": "21.26.001-SNAPSHOT"
}
```
</details>
