...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.21.003).
...
This particular version of the project `21.21.003` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;qP95aHzH5NLwzujogkZi0z4qKbrlac08&#8203;oFPQ</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.21.003
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.21.003")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.21.003")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.21.003
...
```json
{
  ...
  "currentProjectVersion": "21.21.003",
  "incrementalAsInt": "3",
  ...
  "projectCatalogName": "core-utils-21.21.003",
  "projectName": "core-utils:21.21.003",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.21.003",
