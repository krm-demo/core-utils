...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.22.001).
...
This particular version of the project `21.22.001` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;IEhhRyoZYDtN1wOh9Z46rNiyJopeXB4F&#8203;yplZ</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.22.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.22.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.22.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.22.001
...
```json
{
  ...
  "currentProjectVersion": "21.22.001",
  "incrementalAsInt": "1",
  ...
  "projectCatalogName": "core-utils-21.22.001",
  "projectName": "core-utils:21.22.001",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.22.001",
