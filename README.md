...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.20.001).
...
This particular version of the project `21.20.001` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;jWfhzVJh5RoV7290Y57HcrAA2f8VPh2O&#8203;nbex</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.20.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.20.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.20.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.20.001
...
```json
{
  "calculatedProjectVersion": "21.20.001-SNAPSHOT",
  "currentProjectVersion": "21.20.001",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.20.002-SNAPSHOT",
  "internalReleaseVersion": "21.20.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "20",
  "minorVersionAsInt": "20",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.20.001",
  "projectName": "core-utils:21.20.001",
