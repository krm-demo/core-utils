...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.23.003).
...
This particular version of the project `21.23.003` is an _INTERNAL_-release version, which consists of
...
> [!IMPORTANT]
> It's highly recommended to use the _PUBLIC_-release version [![Latest-Public](https://img.shields.io/badge/core--utils-21.22-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.22), 
> because this one could be not stable enough. 
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;HhTD3mdfW2Tl03UYsGN9OBBd5ncSyO22&#8203;42qX</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.23.003
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.23.003")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.23.003")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.23.003
...
```json
{
  "releaseCatalog": {
    "current-snapshot-group": {
      "minor-group-info": "<< unreleased >> 16 commits",
      "commits-one-line": [
...
```json
{
  "calculatedProjectVersion": "21.23.003-SNAPSHOT",
  "currentProjectVersion": "21.23.003",
  "incrementalAsInt": "3",
  "incrementalVersion": "3",
  "internalNextVersion": "21.23.004-SNAPSHOT",
  "internalReleaseVersion": "21.23.003",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "23",
  "minorVersionAsInt": "23",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.23.003",
  "projectName": "core-utils:21.23.003",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.23.003",
