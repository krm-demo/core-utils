...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.001-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.001 "GH-Package 'io.github.krm-demo.core-utils':21.24.001")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.001).
...
This particular version of the project `21.24.001` is an _INTERNAL_-release version, which consists of
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.001
...
```json
{
  "calculatedProjectVersion": "21.24.001-SNAPSHOT",
  "currentProjectVersion": "21.24.001",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.24.002-SNAPSHOT",
  "internalReleaseVersion": "21.24.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "24",
  "minorVersionAsInt": "24",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.24.001",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.001",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.001",
