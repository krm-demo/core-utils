...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.007-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.007 "GH-Package 'io.github.krm-demo.core-utils':21.24.007")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.007).
...
This particular version of the project `21.24.007` is an _INTERNAL_-release version, which consists of
...
> [!IMPORTANT]
> It's highly recommended to use the _PUBLIC_-release [**`core-utils:21.23`**](https://github.com/krm-demo/core-utils/tree/21.23),
...
> with workflow-job [`release-internal #99`](https://github.com/krm-demo/core-utils/actions/runs/19220565732)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;5iXvpN5Ezqj6DvAAsdkh1uQYC2SETL1p&#8203;OGQC</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.007
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.007")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.007")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.007
...
```json
{
  ...
  "currentProjectVersion": "21.24.007",
  "incrementalAsInt": "7",
  ...
  "projectCatalogName": "core-utils-21.24.007",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.007",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.007",
