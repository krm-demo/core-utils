...
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.09.002-blue)](https://krm-demo.github.io/core-utils/core-utils-21.09.002)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.09.002).
...
This particular version of the project `21.09.002` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;uqT59QvVTHpCrJkU2ox3BR8eXdkx2i1g&#8203;Enk8</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.09.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.09.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.09.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.09.002
...
```json
{
  ...
  "currentProjectVersion": "21.09.002",
  "incrementalAsInt": "2",
  ...
  "projectBadgeName": "core--utils:21.09.002",
  "projectCatalogName": "core-utils-21.09.002",
  "projectName": "core-utils:21.09.002",
