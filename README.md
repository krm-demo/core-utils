...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.14).
...
This particular version of the project `21.14` is an _PUBLIC_-release version, which consists of
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.14")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.14")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.14
...
```json
{
  "calculatedProjectVersion": "21.14.000-SNAPSHOT",
  "currentProjectVersion": "21.14",
  "incrementalAsInt": "0",
  "incrementalVersion": "0",
  "internalNextVersion": "21.14.001-SNAPSHOT",
  "internalReleaseVersion": "21.14.000",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "14",
  "minorVersionAsInt": "14",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.14",
  "projectName": "core-utils:21.14",
