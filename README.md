...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.005-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.005 "GH-Package 'io.github.krm-demo.core-utils':21.24.005")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.005).
...
This particular version of the project `21.24.005` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #97`](https://github.com/krm-demo/core-utils/actions/runs/19218187981)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;XmUXPAvgnC2a7AdIWjUVNdOQorUG7i1B&#8203;uda8</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.005
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.005")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.005")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.005
...
```json
{
  ...
  "currentProjectVersion": "21.24.005",
  "incrementalAsInt": "5",
  ...
  "projectCatalogName": "core-utils-21.24.005",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.005",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.005",
