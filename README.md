[![on-main-push](https://github.com/krm-demo/core-utils/actions/workflows/on-main-push.yml/badge.svg?event=push)](https://github.com/krm-demo/core-utils/actions/workflows/on-main-push.yml)  [![Latest-Public](https://img.shields.io/badge/core--utils-21.17-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.17) [![Latest-Internal](https://img.shields.io/badge/core--utils-21.18.002-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.18.002) [![Snapshot-Version](https://img.shields.io/badge/core--utils-21.18.003--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils)

[![Release-Catalog](https://img.shields.io/badge/Release_Catalog-4D7A97?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/) [![Latest-Public](https://img.shields.io/badge/core--utils-21.17-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.17) [![Latest-Internal](https://img.shields.io/badge/core--utils-21.18.002-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.18.002) [![Snapshot-Version](https://img.shields.io/badge/core--utils-21.18.003--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.18.003-SNAPSHOT)  
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.18.003-SNAPSHOT).
...
This particular version of the project `21.18.003-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
- major version `21` (that corresponds to minimum available version of JDK);
- minor version `18` (the ordinal number of _PUBLIC_-release);
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.18.003-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.18.003-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.18.003-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.18.003-SNAPSHOT
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18699906737).
...
```json
{
  "calculatedProjectVersion": "21.18.003-SNAPSHOT",
  "currentProjectVersion": "21.18.003-SNAPSHOT",
  "incrementalAsInt": "3",
  "incrementalVersion": "3",
  "internalNextVersion": "21.18.004-SNAPSHOT",
  "internalReleaseVersion": "21.18.003",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "18",
  "minorVersionAsInt": "18",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.18.003-SNAPSHOT",
  "projectName": "core-utils:21.18.003-SNAPSHOT",
  "publicNextVersion": "21.19.001-SNAPSHOT",
  "publicReleaseVersion": "21.18",
