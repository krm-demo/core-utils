...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.002-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.002 "GH-Package 'io.github.krm-demo.core-utils':21.24.002")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.002).
...
This particular version of the project `21.24.002` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #94`](https://github.com/krm-demo/core-utils/actions/runs/19217052347)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;9OYnnhp9biOe7RpDh3vroFHHQtZ6yz3n&#8203;ltOZ</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.002
...
```json
{
  "releaseCatalog": {
    "current-snapshot-group": {
      "minor-group-info": "<< unreleased >> 31 commits",
      "commits-one-line": [
...
```json
{
  "calculatedProjectVersion": "21.24.002-SNAPSHOT",
  "currentProjectVersion": "21.24.002",
  "incrementalAsInt": "2",
  "incrementalVersion": "2",
  "internalNextVersion": "21.24.003-SNAPSHOT",
  "internalReleaseVersion": "21.24.002",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "24",
  "minorVersionAsInt": "24",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.24.002",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.002",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.002",
