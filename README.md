...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.28.001-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.28.001 "GH-Package 'io.github.krm-demo.core-utils':21.28.001")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.28.001).
...
This particular version of the project `21.28.001` is an _INTERNAL_-release version, which consists of
...
> [!IMPORTANT]
> It's highly recommended to use the _PUBLIC_-release [**`core-utils:21.27`**](https://github.com/krm-demo/core-utils/tree/21.27),
...
> with workflow-job [`release-internal #100`](https://github.com/krm-demo/core-utils/actions/runs/19289347432)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;lXx8bFcKnhUgq1xqDODjMH8f0Rxqop0T&#8203;3GZQ</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.28.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.28.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.28.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.28.001
...
```json
{
  "releaseCatalog": {
    "current-snapshot-group": {
      "minor-group-info": "<< unreleased >> 10 commits",
      "commits-one-line": [
...
```json
{
  "calculatedProjectVersion": "21.28.001-SNAPSHOT",
  "currentProjectVersion": "21.28.001",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.28.002-SNAPSHOT",
  "internalReleaseVersion": "21.28.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "28",
  "minorVersionAsInt": "28",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.28.001",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.28.001",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.28.001",
