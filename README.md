...
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.07.001--SNAPSHOT-blue)](https://krm-demo.github.io/core-utils/core-utils-21.07.001-SNAPSHOT)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.07.001-SNAPSHOT).
...
```json
{
  ...
  "currentProjectVersion": "21.07.001-SNAPSHOT",
  "incrementalAsInt": "1",
  ...
  "projectBadgeName": "core--utils:21.07.001--SNAPSHOT",
  "projectCatalogName": "core-utils-21.07.001-SNAPSHOT",
  "projectName": "core-utils:21.07.001-SNAPSHOT",
...
This particular version of the project `21.07.001-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.07.001-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.07.001-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.07.001-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.07.001-SNAPSHOT
