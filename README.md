...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.12.003).
...
This particular version of the project `21.12.003` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;PGrUKxngS9PEk0iHjuQzonoonEywN31r&#8203;IWU7</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.12.003
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.12.003")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.12.003")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.12.003
...
```json
{
  "calculatedProjectVersion": "21.12.003-SNAPSHOT",
  "currentProjectVersion": "21.12.003",
  "incrementalAsInt": "3",
  "incrementalVersion": "3",
  "internalNextVersion": "21.12.004-SNAPSHOT",
  "internalReleaseVersion": "21.12.003",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "12",
  "minorVersionAsInt": "12",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.12.003",
  "projectName": "core-utils:21.12.003",
