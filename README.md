[![release-internal](https://github.com/krm-demo/core-utils/actions/workflows/release-internal.yml/badge.svg)](https://github.com/krm-demo/core-utils/actions/workflows/release-internal.yml)
...
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.08.001-blue)](https://krm-demo.github.io/core-utils/core-utils-21.08.001)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.08.001).
...
```json
{
  "calculatedProjectVersion": "21.08.001-SNAPSHOT",
  "currentProjectVersion": "21.08.001",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.08.002-SNAPSHOT",
  "internalReleaseVersion": "21.08.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "8",
  "minorVersionAsInt": "8",
  "projectArtifact": "core-utils",
  "projectBadgeName": "core--utils:21.08.001",
  "projectCatalogName": "core-utils-21.08.001",
  "projectName": "core-utils:21.08.001",
...
This particular version of the project `21.08.001` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;X7urpwFoUfkJRmKundTNlVg7lu0orx1p&#8203;IEUz</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.08.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.08.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.08.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.08.001
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18205497598).
