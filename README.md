...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.16.002).
...
This particular version of the project `21.16.002` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;XclTWZaAf5sAYMMHFiUfYCEejbokP04J&#8203;saIx</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.16.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.16.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.16.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.16.002
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18637087077).
...
```json
{
  "releaseCatalog": {
    "current-snapshot-group": {
      "minor-group-info": "<< unreleased >> 20 commits",
      "commits-one-line": [
...
```json
{
  ...
  "currentProjectVersion": "21.16.002",
  "incrementalAsInt": "2",
  ...
  "projectCatalogName": "core-utils-21.16.002",
  "projectName": "core-utils:21.16.002",
