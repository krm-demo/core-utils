...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.23.005).
...
This particular version of the project `21.23.005` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #87`](https://github.com/krm-demo/core-utils/actions/runs/19062113448)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;NUPVAtiEeeyGacdudqc4TK652LFjxR3n&#8203;6dNW</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.23.005
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.23.005")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.23.005")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.23.005
...
```json
{
  ...
  "currentProjectVersion": "21.23.005",
  "incrementalAsInt": "5",
  ...
  "projectCatalogName": "core-utils-21.23.005",
  "projectName": "core-utils:21.23.005",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.23.005",
