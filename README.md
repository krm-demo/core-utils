...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.21.004-SNAPSHOT).
...
This particular version of the project `21.21.004-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.21.004-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.21.004-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.21.004-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.21.004-SNAPSHOT
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18889026821).
...
```json
{
  "calculatedProjectVersion": "21.21.004-SNAPSHOT",
  "currentProjectVersion": "21.21.004-SNAPSHOT",
  "incrementalAsInt": "4",
  "incrementalVersion": "4",
  "internalNextVersion": "21.21.005-SNAPSHOT",
  "internalReleaseVersion": "21.21.004",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "21",
  "minorVersionAsInt": "21",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.21.004-SNAPSHOT",
  "projectName": "core-utils:21.21.004-SNAPSHOT",
...
```json
{
  ...
  "badgeLatestInternalGitHubMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.21.003-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.21.003)",
  "badgeLatestInternalJavaDocMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.21.003-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.21.003)",
  ...
  "badgeSnapshotGitHubMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.21.004--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils)",
  "badgeSnapshotJavaDocMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.21.004--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.21.004-SNAPSHOT)",
  "badgeUrlLatestInternalGitHub": "https://img.shields.io/badge/core--utils-21.21.003-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlLatestInternalJavaDoc": "https://img.shields.io/badge/core--utils-21.21.003-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "badgeUrlSnapshotGitHub": "https://img.shields.io/badge/core--utils-21.21.004--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlSnapshotJavaDoc": "https://img.shields.io/badge/core--utils-21.21.004--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/main",
  "latestInternalAvailable": "true",
  "latestInternalVersion": "21.21.003",
  "latestPublicAvailable": "true",
  "latestPublicVersion": "21.20",
  "mavenInternal": "true",
  "mavenSnapshot": "true",
  "snapshotVersion": "21.21.004-SNAPSHOT"
}
```
</details>
