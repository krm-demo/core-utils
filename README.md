...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.23.007-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.23.007 "GH-Package 'io.github.krm-demo.core-utils':21.23.007")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.23.007).
...
This particular version of the project `21.23.007` is an _INTERNAL_-release version, which consists of
...
> [!IMPORTANT]
> It's highly recommended to use the _PUBLIC_-release [**`core-utils:21.22`**](https://github.com/krm-demo/core-utils/tree/21.22),
...
> with workflow-job [`release-internal #89`](https://github.com/krm-demo/core-utils/actions/runs/19117969970)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;C47eWkW53H4WwzhgM3M2RSZqHeEHOe27&#8203;OK0M</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.23.007
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.23.007")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.23.007")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.23.007
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/19117969970).
...
```json
{
  ...
  "currentProjectVersion": "21.23.007",
  "incrementalAsInt": "7",
  ...
  "projectCatalogName": "core-utils-21.23.007",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.23.007",
...
```json
{
  ...
  "badgeLatestInternalGitHubMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.23.007-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.23.007)",
  "badgeLatestInternalJavaDocMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.23.007-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.23.007)",
  ...
  "badgeUrlLatestInternalGitHub": "https://img.shields.io/badge/core--utils-21.23.007-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlLatestInternalJavaDoc": "https://img.shields.io/badge/core--utils-21.23.007-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.23.007",
  "latestInternalAvailable": "true",
  "latestInternalGitHubUrl": "https://github.com/krm-demo/core-utils/tree/21.23.007",
  "latestInternalJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.23.007",
  "latestInternalVersion": "21.23.007",
