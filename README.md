...
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.08.002--SNAPSHOT-blue)](https://krm-demo.github.io/core-utils/core-utils-21.08.002-SNAPSHOT)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.08.002-SNAPSHOT).
...
```json
{
  "calculatedProjectVersion": "21.08.002-SNAPSHOT",
  "currentProjectVersion": "21.08.002-SNAPSHOT",
  "incrementalAsInt": "2",
  "incrementalVersion": "2",
  "internalNextVersion": "21.08.003-SNAPSHOT",
  "internalReleaseVersion": "21.08.002",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "8",
  "minorVersionAsInt": "8",
  "projectArtifact": "core-utils",
  "projectBadgeName": "core--utils:21.08.002--SNAPSHOT",
  "projectCatalogName": "core-utils-21.08.002-SNAPSHOT",
  "projectName": "core-utils:21.08.002-SNAPSHOT",
...
This particular version of the project `21.08.002-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.08.002-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.08.002-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.08.002-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.08.002-SNAPSHOT
