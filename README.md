...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.10.002).
...
This particular version of the project `21.10.002` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;HRKyuf9TK9mIdTvHLL6S1z01Quie3e23&#8203;LHIQ</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.10.002
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.10.002")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.10.002")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.10.002
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18458543560).
...
```json
{
  "calculatedProjectVersion": "21.10.002-SNAPSHOT",
  "currentProjectVersion": "21.10.002",
  "incrementalAsInt": "2",
  "incrementalVersion": "2",
  "internalNextVersion": "21.10.003-SNAPSHOT",
  "internalReleaseVersion": "21.10.002",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "10",
  "minorVersionAsInt": "10",
  "projectArtifact": "core-utils",
  "projectBadgeName": "core--utils:21.10.002",
  "projectCatalogName": "core-utils-21.10.002",
  "projectName": "core-utils:21.10.002",
