...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.29.001-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.29.001 "GH-Package 'io.github.krm-demo.core-utils':21.29.001")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.29.001).
...
This particular version of the project `21.29.001` is an _INTERNAL_-release version, which consists of
...
- incremental version `1` (the ordinal number of _INTERNAL_-release after the previous _PUBLIC_-release);
...
> with workflow-job [`release-internal #101`](https://github.com/krm-demo/core-utils/actions/runs/19349322304)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;uzQLgQz8MnDRycQhPZQ33hekQjbpAm1d&#8203;7go6</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.29.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.29.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.29.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.29.001
...
```json
{
  "calculatedProjectVersion": "21.29.001-SNAPSHOT",
  "currentProjectVersion": "21.29.001",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.29.002-SNAPSHOT",
  "internalReleaseVersion": "21.29.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "29",
  "minorVersionAsInt": "29",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.29.001",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.29.001",
  "props": {
    ...
    "maven-project.build-date-time": "2025-11-13T23:42:25.235Z",
    ...
    "maven-project.version": "21.29.001",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.29.001",
