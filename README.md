...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.006-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.006 "GH-Package 'io.github.krm-demo.core-utils':21.24.006")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.006).
...
This particular version of the project `21.24.006` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #98`](https://github.com/krm-demo/core-utils/actions/runs/19219665433)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;KWnWkLywrbALCRgihvgrK0UXmbwv6d3L&#8203;VcPC</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.006
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.006")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.006")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.006
...
```json
{
  ...
  "currentProjectVersion": "21.24.006",
  "incrementalAsInt": "6",
  ...
  "projectCatalogName": "core-utils-21.24.006",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.006",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.006",
