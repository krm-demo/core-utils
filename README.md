...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.29.004-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.29.004 "GH-Package 'io.github.krm-demo.core-utils':21.29.004")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.29.004).
...
This particular version of the project `21.29.004` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #104`](https://github.com/krm-demo/core-utils/actions/runs/22022134257)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;fvfn415IF25SeI993i3BlvNcFeMvhY14&#8203;moQh</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.29.004
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.29.004")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.29.004")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.29.004
...
```json
{
  ...
  "currentProjectVersion": "21.29.004",
  "incrementalAsInt": "4",
  ...
  "projectCatalogName": "core-utils-21.29.004",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.29.004",
  "props": {
    ...
    "maven-project.build-date-time": "2026-02-14T18:23:25.257Z",
    ...
    "maven-project.version": "21.29.004",
    ...
    "parsedVersion.osgiVersion": "21.29.4",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.29.004",
