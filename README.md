...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.23.004).
...
This particular version of the project `21.23.004` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;kkP3bCbj4QpcEx85F3pRuv7vSzYKA01m&#8203;Dw3k</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.23.004
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.23.004")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.23.004")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.23.004
...
```json
{
  ...
  "currentProjectVersion": "21.23.004",
  "incrementalAsInt": "4",
  ...
  "projectCatalogName": "core-utils-21.23.004",
  "projectName": "core-utils:21.23.004",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.23.004",
