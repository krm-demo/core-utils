...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.19).
...
This particular version of the project `21.19` is an _PUBLIC_-release version, which consists of
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.19")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.19")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.19
...
```json
{
  "calculatedProjectVersion": "21.19.000-SNAPSHOT",
  "currentProjectVersion": "21.19",
  "incrementalAsInt": "0",
  "incrementalVersion": "0",
  "internalNextVersion": "21.19.001-SNAPSHOT",
  "internalReleaseVersion": "21.19.000",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "19",
  "minorVersionAsInt": "19",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.19",
  "projectName": "core-utils:21.19",
