...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.003-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.003 "GH-Package 'io.github.krm-demo.core-utils':21.24.003")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.003).
...
This particular version of the project `21.24.003` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #95`](https://github.com/krm-demo/core-utils/actions/runs/19217330407)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;Y7cXo3S8lAOo55j3nddjmQXZBmiP3x31&#8203;Jy6M</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.003
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.003")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.003")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.003
...
```json
{
  ...
  "currentProjectVersion": "21.24.003",
  "incrementalAsInt": "3",
  ...
  "projectCatalogName": "core-utils-21.24.003",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.003",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.003",
