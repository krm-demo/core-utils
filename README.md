...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.10.004).
...
This particular version of the project `21.10.004` is an _INTERNAL_-release version, which consists of
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.10.004
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.10.004")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.10.004")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.10.004
...
```json
{
  ...
  "currentProjectVersion": "21.10.004",
  "incrementalAsInt": "4",
  ...
  "projectBadgeName": "core--utils:21.10.004",
  "projectCatalogName": "core-utils-21.10.004",
  "projectName": "core-utils:21.10.004",
