...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.21).
...
This particular version of the project `21.21` is an _PUBLIC_-release version, which consists of
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.21")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.21")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.21
...
```json
{
  "calculatedProjectVersion": "21.21.000-SNAPSHOT",
  "currentProjectVersion": "21.21",
  "incrementalAsInt": "0",
  "incrementalVersion": "0",
  "internalNextVersion": "21.21.001-SNAPSHOT",
  "internalReleaseVersion": "21.21.000",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "21",
  "minorVersionAsInt": "21",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.21",
  "projectName": "core-utils:21.21",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.21",
