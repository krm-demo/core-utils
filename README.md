...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.16.002-SNAPSHOT).
...
This particular version of the project `21.16.002-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.16.002-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.16.002-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.16.002-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.16.002-SNAPSHOT
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18485251888).
...
```json
{
  "calculatedProjectVersion": "21.16.002-SNAPSHOT",
  "currentProjectVersion": "21.16.002-SNAPSHOT",
  "incrementalAsInt": "2",
  "incrementalVersion": "2",
  "internalNextVersion": "21.16.003-SNAPSHOT",
  "internalReleaseVersion": "21.16.002",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "16",
  "minorVersionAsInt": "16",
  "projectArtifact": "core-utils",
  "projectCatalogName": "core-utils-21.16.002-SNAPSHOT",
  "projectName": "core-utils:21.16.002-SNAPSHOT",
