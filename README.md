...
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.07.001-blue)](https://krm-demo.github.io/core-utils/core-utils-21.07.001)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.07.001).
...
```json
{
  "calculatedProjectVersion": "21.07.001-SNAPSHOT",
  "currentProjectVersion": "21.07.001",
  "incrementalAsInt": "1",
  "incrementalVersion": "1",
  "internalNextVersion": "21.07.002-SNAPSHOT",
  "internalReleaseVersion": "21.07.001",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "7",
  "minorVersionAsInt": "7",
  "projectArtifact": "core-utils",
  "projectBadgeName": "core--utils:21.07.001",
  "projectCatalogName": "core-utils-21.07.001",
  "projectName": "core-utils:21.07.001",
...
This particular version of the project `21.07.001` is an _INTERNAL_-release version, which consists of
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;gdAatA0x0y8Ffp9Gm54JEPJP1roCcb0c&#8203;mzer</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.07.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.07.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.07.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.07.001
