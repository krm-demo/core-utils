...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.29.002-SNAPSHOT).
...
This particular version of the project `21.29.002-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
The JavaDoc is generated and the [project-site](https://krm-demo.github.io/core-utils/core-utils-21.29.002-SNAPSHOT) is updated,
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.29.002-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.29.002-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.29.002-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.29.002-SNAPSHOT
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/19349322304).
...
```json
{
  ...
  "currentProjectVersion": "21.29.002-SNAPSHOT",
  "incrementalAsInt": "2",
  ...
  "projectCatalogName": "core-utils-21.29.002-SNAPSHOT",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.29.002-SNAPSHOT",
  "props": {
    ...
    "cicd.build.run.id": "19349322304",
    "cicd.build.run.job": "release-internal-next",
    "cicd.build.run.number": "101",
    "cicd.build.run.workflow": "release-internal",
    "cicd.build.run.workflow.commit": "b1b99f5e42a57456b18322856b4b2441a6ad22a4",
    "cicd.build.run.workflow.ref": "krm-demo/core-utils/.github/workflows/release-internal.yml@refs/heads/main",
    "cicd.git.commit": "b1b99f5e42a57456b18322856b4b2441a6ad22a4",
    ...
    "maven-project.build-date-time": "2025-11-13T23:45:22.038Z",
    ...
    "maven-project.version": "21.29.002-SNAPSHOT",
    ...
    "parsedVersion.osgiVersion": "21.29.2.SNAPSHOT",
...
```json
{
  ...
  "badgeLatestInternalGitHubMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.29.001-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/21.29.001)",
  "badgeLatestInternalJavaDocMD": "[![Latest-Internal](https://img.shields.io/badge/core--utils-21.29.001-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.29.001)",
  ...
  "badgeSnapshotGitHubMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.29.002--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black)](https://github.com/krm-demo/core-utils/tree/main)",
  "badgeSnapshotJavaDocMD": "[![Snapshot-Version](https://img.shields.io/badge/core--utils-21.29.002--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.29.002-SNAPSHOT)",
  "badgeUrlLatestInternalGitHub": "https://img.shields.io/badge/core--utils-21.29.001-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlLatestInternalJavaDoc": "https://img.shields.io/badge/core--utils-21.29.001-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  ...
  "badgeUrlSnapshotGitHub": "https://img.shields.io/badge/core--utils-21.29.002--SNAPSHOT-blue?logo=github&logoColor=white&labelColor=black",
  "badgeUrlSnapshotJavaDoc": "https://img.shields.io/badge/core--utils-21.29.002--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97",
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/main",
  "latestInternalAvailable": "true",
  "latestInternalGitHubUrl": "https://github.com/krm-demo/core-utils/tree/21.29.001",
  "latestInternalJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.29.001",
  "latestInternalVersion": "21.29.001",
  ...
  "snapshotJavaDocUrl": "https://krm-demo.github.io/core-utils/core-utils-21.29.002-SNAPSHOT",
  "snapshotVersion": "21.29.002-SNAPSHOT"
}
```
</details>
