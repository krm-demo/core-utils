...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.18.001).
...
This particular version of the project `21.18.001` is an _INTERNAL_-release version, which consists of
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.18.001
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.18.001")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.18.001")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.18.001
...
```json
{
  ...
  "currentProjectVersion": "21.18.001",
  "incrementalAsInt": "1",
  ...
  "projectCatalogName": "core-utils-21.18.001",
  "projectName": "core-utils:21.18.001",
