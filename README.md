...
[![Release-Catalog](https://img.shields.io/badge/Release_Catalog-4D7A97?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/) [![Latest-Public](https://img.shields.io/badge/core--utils-21.09-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.09) [![Latest-Internal](https://img.shields.io/badge/core--utils-21.10.005-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.10.005) [![Snapshot-Version](https://img.shields.io/badge/core--utils-21.10.006--SNAPSHOT-blue?logo=github&logoColor=f8981d&labelColor=4D7A97)](https://krm-demo.github.io/core-utils/core-utils-21.10.006-SNAPSHOT)  
[![Project-Site](https://img.shields.io/badge/GH--Pages-core--utils:21.10.006--SNAPSHOT-blue)](https://krm-demo.github.io/core-utils/core-utils-21.10.006-SNAPSHOT)
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.10.006-SNAPSHOT).
...
This particular version of the project `21.10.006-SNAPSHOT` is a _SNAPSHOT_-version, which consists of:
...
- incremental version  `6` (the ordinal number of _INTERNAL_-release after the latest _PUBLIC_-release);
...
- for main-source dependencies:
    ```XML
        <dependency>
            ...
            <version>21.10.006-SNAPSHOT</artifactId>
        </dependency>
    ```
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.10.006-SNAPSHOT")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.10.006-SNAPSHOT")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.10.006-SNAPSHOT
...
> during GitHub Workflow [`release-internal`](https://github.com/krm-demo/core-utils/actions/runs/18473638750).
...
```json
{
  "calculatedProjectVersion": "21.10.006-SNAPSHOT",
  "currentProjectVersion": "21.10.006-SNAPSHOT",
  "incrementalAsInt": "6",
  "incrementalVersion": "6",
  "internalNextVersion": "21.10.007-SNAPSHOT",
  "internalReleaseVersion": "21.10.006",
  "majorVersion": "21",
  "majorVersionAsInt": "21",
  "minorVersion": "10",
  "minorVersionAsInt": "10",
  "projectArtifact": "core-utils",
  "projectBadgeName": "core--utils:21.10.006--SNAPSHOT",
  "projectCatalogName": "core-utils-21.10.006-SNAPSHOT",
  "projectName": "core-utils:21.10.006-SNAPSHOT",
