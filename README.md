...
[![GitHub-Packages short](https://img.shields.io/badge/GH--Packages-21.24.004-blue?logo=github&logoColor=black&labelColor=b0e0e6)](https://github.com/krm-demo/core-utils/packages/2631343?version=21.24.004 "GH-Package 'io.github.krm-demo.core-utils':21.24.004")
...
Full documentation (including JavDoc) and examples fort this particular version are available [here](https://krm-demo.github.io/core-utils/core-utils-21.24.004).
...
This particular version of the project `21.24.004` is an _INTERNAL_-release version, which consists of
...
> with workflow-job [`release-internal #96`](https://github.com/krm-demo/core-utils/actions/runs/19217863648)
...
- (should be re-masked!) the value of `github_token` should be <code>ghs_&#8203;Scjx6CGzpufacKST3azGBc43t5WIQK0H&#8203;5rwa</code>
...
```bash
...> mvn dependency:get -Dartifact=io.github.krm-demo:core-utils:21.24.004
...
```Gradle
    ...
    implementation("io.github.krm-demo:core-utils:21.24.004")
    . . . . . . . . . . . . . .
    // for test-source implementation dependencies:
    testImplementation("io.github.krm-demo:core-utils:21.24.004")
```
...
```bash
...> jbang io.github.krm-demo:core-utils:21.24.004
...
```json
{
  ...
  "currentProjectVersion": "21.24.004",
  "incrementalAsInt": "4",
  ...
  "projectCatalogName": "core-utils-21.24.004",
  "projectGroup": "io.github.krm-demo",
  "projectName": "core-utils:21.24.004",
...
```json
{
  ...
  "gitHubCurrentRootUrl": "https://github.com/krm-demo/core-utils/tree/21.24.004",
